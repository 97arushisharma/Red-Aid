...
public class details extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener,
    ...
    private String name = "Red Aid User";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRef= new Firebase("https://red-aid-598b1.firebaseio.com/");
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String tester = "^[0-9]{10}$";


                mRef1= new Firebase("https://red-aid-598b1.firebaseio.com/"+uid);
                ...
                if (long2==0 && lat2==0){
                    // invalid address
                    Toast.makeText(details.this, "Enter valid locality", LENGTH_SHORT).show();
                    return;
                }
                ...
                if(!TextUtils.isEmpty(et1.getText().toString().trim())){
                    ...
                    Toast.makeText(details.this, "Enter your locality", LENGTH_SHORT).show();
                ...
                else if(!number.matches(tester) ){
                    Toast.makeText(details.this, "Invalid contact no.", LENGTH_SHORT).show();
                    //stopping the function execution further
                    return;
                }
                else  if(TextUtils.isEmpty(height)){
                    //email is empty
                    Toast.makeText(details.this, "please enter your height in feets", LENGTH_SHORT).show();
                    //stopping the function execution further
                    return;
                }
                    ...
                    Toast.makeText(details.this, "Sorry, You are underweight", LENGTH_SHORT).show();
                    //stopping the function execution further
                    return;
                }
               ...
               /* else if(((et3.getText().toString().trim().length())<10)&&((et3.getText().toString().trim().length())>11)){
                ...
                Intent a= new Intent(details.this, aadhar.class);
