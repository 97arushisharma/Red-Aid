...
public class ProfileActivity extends AppCompatActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(getApplicationContext(), "Swipe right to open the navigation drawer", Toast.LENGTH_SHORT).show();
     ...
     //   String uname=u.getDisplayName();
       ...
       //nav_tv= (TextView)navigation.getHeaderView(0).findViewById(R.id.hn);
        ...
        mRef= new Firebase("https://red-aid-598b1.firebaseio.com/"+uid);
            ...
            public void onDataChange(DataSnapshot snapshot) {
                for (DataSnapshot postSnapshot : snapshot.getChildren()) {
                  ...
                  // nav_tv1.setText(navi);
                    ...
                    String name = getIntent().getStringExtra("name11");
    ...
    public void onClick(View view) {
                ...
                Intent i=new Intent(ProfileActivity.this, Profile_map.class);
